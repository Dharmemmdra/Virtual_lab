...
const handleClickc = async () => {
  ...
  return (
        ...
        <div className="wireHor wireHor-2 wireHor-2-1"></div>
        <div className="wireHor wireHor-3 wireHor-3-1"></div>
...
/>
        ...
        <div className="Multiplier Multiplier-1">
        <div className="node4">
...
/>
        ...
        <br />
	  		            ...
	  		            <div className="cont2" align="center">
              <label>
        g:<br/>
<input
  type="range"
...
/>
        ...
        <br/>
        <div className="MasterSignals MasterSignals-2">
        <div className="node2">
            <div className="text2">sin(wt)</div>
            </div>
			<div className="cont" align="center">
